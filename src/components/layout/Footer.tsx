...
const footerLinks = {
  ...
  services: [
    { href: "/cars", label: "Rental Mobil" },
    { href: "/driver", label: "Sewa Sopir" },
    { href: "/airport", label: "Antar Jemput Bandara" },
    { href: "/corporate", label: "Korporat" },
  ],
};
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-secondary-300 mb-6 max-w-md">
              Temukan kebebasan berkendara dengan layanan rental mobil premium kami. 
          ...
          {/* Links */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-4">Perusahaan</h3>
        ...
        <div className="mt-16 pt-8 border-t border-secondary-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-secondary-400 text-sm">
            &copy; {new Date().getFullYear()} CarRental. Hak Cipta Dilindungi.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/terms" className="text-secondary-400 hover:text-primary-500 text-sm">
              Syarat & Ketentuan
            </Link>
            <Link href="/privacy" className="text-secondary-400 hover:text-primary-500 text-sm">
              Kebijakan Privasi
            </Link>
          </div>
        </div>
